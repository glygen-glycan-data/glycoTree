...
$here/scripts/structprops.py $here/data/glygen_allacc.txt $sqlDir/compositions.csv $modelDir/enzymes.csv $modelDir/enzyme_mappings.csv $modelDir/rule_data.tsv > $sqlDir/structure.csv
